...
pickRock.addEventListener('click', function() { playerPick(possiblePicks[0]) });

var pickPaper = document.getElementById('js-playerPick_paper');
pickPaper.addEventListener('click', function() { playerPick(possiblePicks[1]) });

var pickScissors = document.getElementById('js-playerPick_scissors');
pickScissors.addEventListener('click', function() { playerPick(possiblePicks[2]) });
